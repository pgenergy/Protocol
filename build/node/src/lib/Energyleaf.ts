...
// @generated from protobuf file "Energyleaf.proto" (package "energyleaf", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message energyleaf.TokenRequest
 */
...
/**
 * @generated from protobuf message energyleaf.TokenResponse
 */
...
/**
 * @generated from protobuf enum energyleaf.SensorType
 */
...
class TokenRequest$Type extends MessageType<TokenRequest> {
    ...
    internalBinaryWrite(message: TokenRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.needScript !== undefined)
            writer.tag(3, WireType.Varint).bool(message.needScript);
...
/**
 * @generated MessageType for protobuf message energyleaf.TokenResponse
 */
...
class ScriptAcceptedRequest$Type extends MessageType<ScriptAcceptedRequest> {
    constructor() {
        super("energyleaf.ScriptAcceptedRequest", [
            { no: 1, name: "access_token", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message energyleaf.ScriptAcceptedRequest
 */
...
class ScriptAcceptedResponse$Type extends MessageType<ScriptAcceptedResponse> {
    constructor() {
        super("energyleaf.ScriptAcceptedResponse", [
            { no: 1, name: "status", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "status_message", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message energyleaf.ScriptAcceptedResponse
 */
